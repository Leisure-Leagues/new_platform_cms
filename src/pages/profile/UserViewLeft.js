                ...
                <form>
                  <Grid container spacing={6}>
                    <Grid item xs={12} sm={6}>
                      <TextField fullWidth label='Full Name' defaultValue={user.firstName + ' ' + user.lastName} />
                    </Grid>
                    <Grid item xs={12} sm={6}>
                      <TextField
                        fullWidth
                    ...
                    <Grid item xs={12} sm={6}>
                      <TextField fullWidth type='email' label='Email Address' defaultValue={user.email} />
                    </Grid>
                    <Grid item xs={12} sm={6}>
                    ...
                    <Grid item xs={12} sm={6}>
                      <TextField fullWidth label='Address 1' defaultValue={user.address.address} />
                    </Grid>
                    <Grid item xs={12} sm={6}>
                      <TextField fullWidth label='Address 2' defaultValue={user.address.city} />
                    </Grid>
                    <Grid item xs={12} sm={6}>
                      <FormControl fullWidth>
